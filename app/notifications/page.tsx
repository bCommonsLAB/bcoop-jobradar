  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-accent/10 to-accent/20">
      ...
      <div className="max-w-6xl mx-auto px-2 md:px-5 py-2 md:py-5">
        <div className="flex items-center gap-3 md:gap-4 p-3 md:p-4 rounded-xl md:rounded-2xl bg-teal-50 border border-teal-100/80 mb-4 md:mb-5">
          <div className="flex-shrink-0 w-10 h-10 md:w-12 md:h-12 rounded-full bg-teal-100 flex items-center justify-center">
            <Bell className="w-5 h-5 md:w-6 md:h-6 text-teal-700" />
          </div>
          <div className="min-w-0">
            <h2 className="text-sm md:text-base font-semibold text-foreground">{t("notifications.title")}</h2>
            <p className="text-xs md:text-sm text-muted-foreground mt-0.5">{t("notifications.description")}</p>
          </div>
        </div>
        <JobNotifications />
      </div>
